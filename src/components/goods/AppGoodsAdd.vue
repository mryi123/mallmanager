...
<el-card class="box-card">
    ...
    <el-alert title="添加商品信息" center class="ti" type="success" show-icon></el-alert>
    <!-- 步骤条 -->
        ...
        <el-tabs tab-position="left" v-model="active" class="tabs" :before-leave="handlefen" @tab-click="handleTabs()">
            ...
            <el-tab-pane label="商品参数" name="1">
                <el-form-item v-for="(item, index) in goodsParams" :key="index" :label="item.attr_name">
                    ...
                    border v-for="(item1, index) in item.attr_vals"
                    :key="index" :label="item1"></el-checkbox>
                </el-form-item>
            ...
            <el-tab-pane label="商品内容" name="4">
                ...
                <div class="add">
                    <el-button @click="handleAddGoods" type="success">添加</el-button>
                </div>
